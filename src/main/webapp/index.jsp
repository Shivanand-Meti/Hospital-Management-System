...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/network.jpg" class="d-block w-100" alt="..." height="500px">
    </div>
            ...
            <div class="col-md-5">
                 <div class="card paint-card">
                     <div class="card-body">
                        ...
                        <p>lorem ipsum gjfkdg dfhif ikhytuiy tirioi threkt trhioth</p>
                     </div>
                 </div>           
            </div>
             <div class="col-md-5">              
            ...
            <div class="col-md-3">
                 <div class="card paint-card">
                     <div class="card-body text-center">
                        ...
                        <p class="fw-bold fs-5">Dr. Nivishe Paule</p>
            ...
            <div class="col-md-3">
                 <div class="card paint-card">
                     <div class="card-body text-center">
                        ...
                        <p class="fw-bold fs-5">Dr.Martha Samuel</p>
